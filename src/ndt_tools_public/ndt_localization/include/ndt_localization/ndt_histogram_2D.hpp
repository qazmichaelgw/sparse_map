...
namespace perception_oru {
  ...
  public:
     ...
     * @param opening sensor FOV (if -1 do not use)
     */
    histogram_cell(perception_oru::NDTMap *map_, double te_, int ns_, int np_, std::vector<double> begins_, std::vector<double> ends_, double cs_, Eigen::Vector2d origin_, int os_ = 1, double opening = -1);  //constructor for single scan
  ...
  public:
    ...
    histogram_map(perception_oru::NDTMap *map_, double te_, int ns_, int np_,  std::vector<double> begins_, std::vector<double> ends_, double range_, int os_, double opening_ );
